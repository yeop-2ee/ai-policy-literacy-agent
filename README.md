...
**[► 화면 Flow Map 보기](https://htmlpreview.github.io/?https://github.com/yeop-2ee/ai-policy-literacy-agent/blob/main/flowmap.html)**

| 플로우 | 포함 화면 |
|--------|-----------|
| 인증·온보딩 | 로그인/회원가입 · 온보딩 생년월일 · 온보딩 관심분야 |
| 메인 플로우 | 대시보드 · 정책 목록 · 정책 상세 (AI 자격 분석) |
| 부가 기능 | 저장한 정책 · 내 정보/프로필 · 시뮬레이터 선택 · 시뮬레이터 채팅 |
